...
│   ├── index.html                   # HTML template (update meta tags here)
│   ├── manifest.json                # PWA manifest
│   ├── profile.json                 # GitHub data (generated by fetch.js)
│   ├── blogs.json                   # Medium blog data (generated by fetch.js)
│   └── PDFs/                        # Resume, presentations
│
├── src/                             # Main application source
│   ├── index.js                     # React DOM entry point
│   ├── App.js                       # Root component (renders VersionRouter)
│   ├── serviceWorker.js             # PWA support
│   │
│   ├── routes/
│   │   └── VersionRouter.js         # 🎯 Main router with lazy loading
│   │
│   ├── shared/                      # Shared code across all versions
│   │   ├── data/
│   │   │   └── portfolio.js         # 📊 MASTER CONFIG - All portfolio content
│   │   ├── contexts/
│   │   │   └── StyleContext.js      # Theme management (light/dark mode)
│   │   ├── hooks/
│   │   │   └── useLocalStorage.js   # Custom hook for persistence
│   │   └── utils.js                 # Utility functions
│   │
│   ├── versions/                    # Multiple portfolio versions
│   │   ├── config.js                # 🎯 Default version configuration
│   │   ├── QUICK_REFERENCE.md       # Version system quick guide
│   │   │
...
│   │       │   ├── Header/
│   │       │   └── Footer/
│   │       ├── containers/          # Modern page sections
│   │       │   ├── Main.js          # Main layout container
│   │       │   ├── Hero/
│   │       │   ├── Services/
│   │       │   ├── Portfolio/
...
│
├── Scripts
│   └── fetch.js                     # Node.js script to fetch GitHub/Medium data
│
└── Documentation
    ├── README.md                    # User-facing documentation
    ├── MULTI_VERSION_GUIDE.md       # Multi-version system guide
...
### URL Structure
- `/` → Redirects to DEFAULT_VERSION (currently v2)
- `/v1` → Version 1 (Classic design)
- `/v2` → Version 2 (Modern design)
- Any other path → Redirects to DEFAULT_VERSION
...
```javascript
// ❌ BAD: Creating new unnecessary files
await Write({
...
// ❌ BAD (may not render on all platforms)
...
✅ **Lazy loading** - Versions loaded on-demand via `React.lazy()`
✅ **Code splitting** - Separate bundles for v1 and v2
